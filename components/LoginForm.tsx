    ...
    <div className="bg-broadcast min-h-screen flex flex-col items-center justify-center px-4 py-8">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[rgba(245,239,224,0.45)] text-xs mt-2 tracking-widest uppercase">
        ...
        <div className="glass-card p-7">
          <h2 className="text-center text-[rgba(245,239,224,0.7)] text-sm mb-6 font-normal">
        ...
        <p className="text-center text-xs mt-6" style={{ color: 'rgba(245,239,224,0.2)' }}>
